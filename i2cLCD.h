...
#include <string.h>
#include <stdbool.h>
#ifndef _I2CLCD_H    /* Guard against multiple inclusion */
#define _I2CLCD_H
...
extern "C" {
    ...
    void LCDInit(uint8_t a_numLines, uint8_t a_numColumns, int8_t a_Contrast, bool is5V,uint8_t waitTick) ;
    void LCDWriteCmdByteSync(uint8_t dat , uint8_t wait);
    void LCDWriteDataBytesSync(unsigned char *buf , uint8_t wait);
    void LCDWriteText(unsigned char *);
    void LCDClear(void);
    void LCDHome(void);
